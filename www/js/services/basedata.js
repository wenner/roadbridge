...
angular.module("bridge.services")
    .factory("BaseData", function(){
        var datas = {
            ...
            bujians: [
                {name:"上部主要承重构件" , code:"TCmain" , buwei:"上部/下部结构"} ,
                {name:"上部一般承重构件" , code:"TCnormal" , buwei:"上部/下部结构"} ,
                {name:"支座" , code:"TCsupport" , buwei:"上部/下部结构"} ,
                {name:"翼墙/耳墙" , code:"BCwingwall" , buwei:"上部/下部结构"} ,
                {name:"锥坡/护坡" , code:"BCslope" , buwei:"上部/下部结构"} ,
                {name:"桥墩" , code:"BCpier" , buwei:"上部/下部结构"} ,
                {name:"桥台" , code:"BCabutment" , buwei:"上部/下部结构"} ,
                {name:"墩台基础" , code:"BCbase" , buwei:"上部/下部结构"} ,
                {name:"河床" , code:"BCbed" , buwei:"上部/下部结构"} ,
                {name:"调治构造物" , code:"BCrs" , buwei:"上部/下部结构"} ,
                {name:"桥面铺装" , code:"BCpaving" , buwei:"桥面系"} ,
                {name:"伸缩缝装置" , code:"BCjoint" , buwei:"桥面系"} ,
                {name:"人行道" , code:"BCsidewalk" , buwei:"桥面系"} ,
                {name:"栏杆护栏" , code:"BCrail" , buwei:"桥面系"} ,
                {name:"排水系统" , code:"BCdrain" , buwei:"桥面系"} ,
                {name:"照明/标志" , code:"BDlight" , buwei:"桥面系"}
            ] ,
            leibies: [
                //上部主要承重构件-default ,
